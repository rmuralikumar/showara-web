  ...
  return (
    <div className="min-h-screen py-8 sm:py-12 pb-16 pb-safe bg-[var(--bg-main)]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pl-safe pr-safe space-y-6">
        ...
        <h1 className="text-3xl font-black text-[var(--text-primary)] tracking-tight">Privacy Policy</h1>
        ...
        <div className="space-y-4 text-xs text-[var(--text-secondary)] leading-relaxed p-6 rounded-3xl bg-[var(--bg-surface-card)] border border-[var(--border-subtle)]">
          <h2 className="text-sm font-bold text-[var(--text-primary)]">1. Data We Collect</h2>
          <p>
          ...
          <h2 className="text-sm font-bold text-[var(--text-primary)] pt-2">2. Payment Security</h2>
          <p>
          ...
          <h2 className="text-sm font-bold text-[var(--text-primary)] pt-2">3. Zero Third-Party Advertising</h2>
          <p>
